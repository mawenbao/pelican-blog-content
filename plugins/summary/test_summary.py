...
from pelican._contents import Page
...
class TestSummary(unittest.TestCase):
    ...
    def test_end_summary(self):
        ...
        self.assertEqual(page._content, TEST_SUMMARY + TEST_CONTENT)
    ...
    def test_begin_summary(self):
        ...
        self.assertEqual(page._content, 'FOOBAR' + TEST_CONTENT)
    ...
    def test_begin_end_summary(self):
        ...
        # test both the summary and the marker removal
        self.assertEqual(page.summary, TEST_SUMMARY)
        self.assertEqual(page._content, 'FOOBAR' + TEST_SUMMARY + TEST_CONTENT)
